"""LibreConvNeXt ONNX export: single logits output, numerics match eager."""
...
def test_export_onnx_round_trip_matches_eager():
    ...
    from libreyolo import LibreConvNeXt

    eager = LibreConvNeXt(size="t", nb_classes=1000, device="cpu")
    eager.model.eval()
